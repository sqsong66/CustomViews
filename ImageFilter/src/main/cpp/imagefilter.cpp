...
Java_com_sqsong_imagefilter_NativeLib_applyRGBCurve(JNIEnv *env, jobject thiz, jintArray pixels, jintArray rgb, jint width, jint height) {
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_sqsong_imagefilter_NativeLib_applyChannelCurves(JNIEnv *env, jobject thiz, jintArray pixels, jintArray r, jintArray g, jintArray b, jint width, jint height) {
    jint *pixelsBuff = getPointerArray(env, pixels);
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_sqsong_imagefilter_NativeLib_doBrightness(JNIEnv *env, jobject thiz, jintArray pixels, jint value, jint width, jint height) {
    jint *pixelsBuff = getPointerArray(env, pixels);
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_sqsong_imagefilter_NativeLib_doContrast(JNIEnv *env, jobject thiz, jintArray pixels, jfloat value, jint width, jint height) {
    jint *pixelsBuff = getPointerArray(env, pixels);
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_sqsong_imagefilter_NativeLib_doColorOverlay(JNIEnv *env, jobject thiz, jintArray pixels, jint depth, jfloat red, jfloat green, jfloat blue, jint width, jint height) {
    jint *pixelsBuff = getPointerArray(env, pixels);
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_sqsong_imagefilter_NativeLib_doSaturation(JNIEnv *env, jobject thiz, jintArray pixels, jfloat level, jint width, jint height) {
    jint *pixelsBuff = getPointerArray(env, pixels);
