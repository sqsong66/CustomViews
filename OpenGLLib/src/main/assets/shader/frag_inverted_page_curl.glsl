...
float cylinderAngle = 0.0; // 360 degrees * amount
...
void main() {
    float adjustedProgress = holdEase(progress, textureStayRatio);
    amount = adjustedProgress * (MAX_AMOUNT - MIN_AMOUNT) + MIN_AMOUNT;
