...
public class GLTextureView extends TextureView
    ...
    public EGLConfigChooser getDefaultEGLConfigChooser(boolean withDepthBuffer) {
        return new SimpleEGLConfigChooser(withDepthBuffer);
    }
        ...
        public void start() {
            ...
            if (view == null) {
                ...
                if (eglContext == null || eglContext == EGL10.EGL_NO_CONTEXT) {
                    eglConfig = view.getDefaultEGLConfigChooser(true).chooseConfig(egl, eglDisplay);
                    eglContext = view.eglContextFactory.createContext(egl, eglDisplay, eglConfig);
                }
            }
            if (eglContext == null || eglContext == EGL10.EGL_NO_CONTEXT) {
